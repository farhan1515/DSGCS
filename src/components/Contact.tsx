  ...
  const contactInfo = [
    {
      icon: Mail,
      label: "Email",
      value: "info@securitymatterz.com",
      color: "from-[#ff3333] to-[#ff6b35]"
    },
    {
      icon: Phone,
      label: "Phone",
      value: "+966 11 464 8801",
      color: "from-[#3b82f6] to-[#1e40af]"
    },
    {
      icon: Printer,
      label: "Fax",
      value: "+966 11 464 0188",
      color: "from-[#10b981] to-[#059669]"
    },
    {
      icon: MapPin,
      label: "Address",
      value: "Al Taawun Center, Othman Ibn Affan Road (Exit 7), Riyadh",
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
            Connect with our cybersecurity experts to discuss your security needs and 
            discover how we can protect your digital assets with our comprehensive solutions.
          </p>
        </motion.div>
        ...
        >
          ...
          {/* Large Fingerprint Background */}
          <div className="absolute top-1/2 right-8 transform -translate-y-1/2 opacity-10">
            <Fingerprint className="w-64 h-64 md:w-96 md:h-96 text-white" />
          </div>
          ...
          <div className="relative z-10">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div>
                ...
                >
                  Our team of cybersecurity professionals is ready to help you build a robust 
                  defense against evolving digital threats. Contact us today for a consultation.
                </motion.p>
              ...
              <div className="text-center lg:text-left">
                ...
                >
                  <motion.div 
                    className="w-32 h-32 mx-auto lg:mx-0 bg-gradient-to-r from-[#ff3333] to-[#ff6b35] rounded-3xl flex items-center justify-center mb-6 shadow-2xl shadow-red-500/25"
                  ...
                  <p className="text-gray-300 mb-8">
                    Get a free consultation and discover how we can protect your business 
                ...
                >
                  <motion.button
                    className="group w-full lg:w-auto bg-gradient-to-r from-[#ff3333] to-[#ff6b35] text-white px-8 py-4 rounded-2xl font-semibold text-lg flex items-center justify-center space-x-3 hover:shadow-2xl hover:shadow-red-500/40 transition-all duration-300"
